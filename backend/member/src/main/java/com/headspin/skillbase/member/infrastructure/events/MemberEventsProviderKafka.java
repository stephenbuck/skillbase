...
@Slf4j
@ApplicationScoped
public class MemberEventsProviderKafka implements CommonEventsProvider {
    ...
    public MemberEventsProviderKafka(
        @ConfigProperty(name = "com.headspin.skillbase.member.kafka.bootstraps") String configBootstraps,
        @ConfigProperty(name = "com.headspin.skillbase.member.kafka.clientid") String configClientId,
        @ConfigProperty(name = "com.headspin.skillbase.member.kafka.groupid") String configGroupId
    ) {
        // Configure the admin
