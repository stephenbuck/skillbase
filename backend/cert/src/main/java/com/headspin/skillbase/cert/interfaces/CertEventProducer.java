...
public class CertEventProducer {

    private static final Logger logger = Logger.getLogger(CertEventConsumer.class.getName());

    public void produce(CertEvent certEvent) {
