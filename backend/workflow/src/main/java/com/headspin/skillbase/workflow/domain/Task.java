...
public record Task (
    ...
    @Column(name = "id") @EmbeddedId @Id @NotNull TaskId id,

    @Column(name = "peer_id") String peerId,

    @Column(name = "process_id") @ManyToOne @NotNull ProcessId processId,
...
) implements org.jmolecules.ddd.types.Entity<Workflow, TaskId>, Serializable {
