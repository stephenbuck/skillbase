...
public class CatalogCredentialsREST {
    ...
    public Response insert(final CatalogCredential credential) {
    ...
    public Response delete(@PathParam("credential_id") final UUID credential_id) {
    ...
    public Response update(final CatalogCredential credential) {
