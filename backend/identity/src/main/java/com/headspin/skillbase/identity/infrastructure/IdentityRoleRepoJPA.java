...
public class IdentityRoleRepoJPA implements IdentityRoleRepo {
    ...
    public List<IdentityRole> findAllByGroupId(
        ...
        return em.createQuery("SELECT r FROM identity_role r WHERE r.group_id = :groupId ORDER BY :sort", IdentityRole.class)
                .setParameter("sort", Objects.requireNonNullElse(sort, "id"))
                .setFirstResult(Objects.requireNonNullElse(offset, 0))
                .setMaxResults(Objects.requireNonNullElse(limit, 10))
                .getResultList();
    ...
    public List<IdentityRole> findAllByUserId(
        ...
        return em.createQuery("SELECT r FROM identity_role r WHERE r.user_id = :userId ORDER BY :sort", IdentityRole.class)
                .setParameter("sort", Objects.requireNonNullElse(sort, "id"))
                .setFirstResult(Objects.requireNonNullElse(offset, 0))
                .setMaxResults(Objects.requireNonNullElse(limit, 10))
                .getResultList();
