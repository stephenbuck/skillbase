...
public class IdentityUserRepoJPA implements IdentityUserRepo {
    ...
    public List<IdentityUser> findAllByGroupId(
        ...
        return em.createQuery("SELECT u FROM identity_user u WHERE u.group_id = groupId ORDER BY :sort", IdentityUser.class)
                .setParameter("sort", Objects.requireNonNullElse(sort, "id"))
                .setFirstResult(Objects.requireNonNullElse(offset, 0))
                .setMaxResults(Objects.requireNonNullElse(limit, 10))
                .getResultList();
    ...
    public List<IdentityUser> findAllByRoleId(
        ...
        return em.createQuery("SELECT u FROM identity_user u WHERE u.role_id = groupId ORDER BY :sort", IdentityUser.class)
                .setParameter("sort", Objects.requireNonNullElse(sort, "id"))
                .setFirstResult(Objects.requireNonNullElse(offset, 0))
                .setMaxResults(Objects.requireNonNullElse(limit, 10))
                .getResultList();
