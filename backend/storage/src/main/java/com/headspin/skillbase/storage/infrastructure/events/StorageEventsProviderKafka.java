package com.headspin.skillbase.storage.infrastructure.events;
...
public class StorageEventsProviderKafka implements CommonEventsProvider {
    ...
    public StorageEventsProviderKafka() {
    ...
    public void produce(final String topic, final String type, final JsonObject json) {
        ...
        final CloudEvent event = CloudEventBuilder.v1()
                .withSource(URI.create(StorageEvent.SKILLBASE_EVENT_SOURCE))
                .withType(type)
    ...
    public void test() {
        log.info("test:");
        produce(
                StorageEvent.STORAGE_EVENT_TOPIC,
                StorageEvent.STORAGE_FILE_DELETED,
