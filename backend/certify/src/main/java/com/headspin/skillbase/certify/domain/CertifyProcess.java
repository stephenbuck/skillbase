...
@Entity
@Table(name = "certify_process")
public class CertifyProcess implements Serializable {
        ...
        @JsonbProperty("cert_id")
        @Column(name = "cert_id") @NotNull @ManyToOne public UUID certId;
