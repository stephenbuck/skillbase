...
public record CertifyCert(
        ...
        @JsonbProperty("model_id") @Column(name = "model_id") @NotNull @OneToOne UUID modelId,
        ...
        @JsonbProperty("none") @Column(name = "note") @NotNull String note,

        @JsonbProperty("granted_at") @Column(name = "granted_at") @Null @Temporal(TemporalType.TIMESTAMP) Date grantedAt,

        @JsonbProperty("revoked_at") @Column(name = "revoked_at") @Null @Temporal(TemporalType.TIMESTAMP) Date revokedAt,

        @JsonbProperty("expires_at") @Column(name = "expires_at") @Null @Temporal(TemporalType.TIMESTAMP) Date expiresAt,
        ...
        @JsonbProperty("version") @Column(name = "version", columnDefinition = "integer DEFAULT 0") @NotNull @Version Long version
