...
public class CertifyModelRepoJPA implements CertifyModelRepo {
    ...
    public List<CertifyModel> findAllBySkillId(
        ...
        return em.createQuery("SELECT m FROM certify_model m WHERE m.skill_id = :skillId ORDER BY :sort", CertifyModel.class)
                .setParameter("sort", Objects.requireNonNullElse(sort, "id"))
                .setFirstResult(Objects.requireNonNullElse(offset, 0))
                .setMaxResults(Objects.requireNonNullElse(limit, 10))
                .getResultList();
    ...
    public List<CertifyModel> findAllByUserId(
        ...
        return em.createQuery("SELECT m FROM certify_model m WHERE m.user_id = :userId ORDER BY :sort", CertifyModel.class)
                .setParameter("sort", Objects.requireNonNullElse(sort, "id"))
                .setFirstResult(Objects.requireNonNullElse(offset, 0))
                .setMaxResults(Objects.requireNonNullElse(limit, 10))
                .getResultList();
