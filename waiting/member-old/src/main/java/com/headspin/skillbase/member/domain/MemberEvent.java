...
public class MemberEvent implements Serializable {
    ...
    public static final String MEMBER_ROLE_CREATED = "com.headspin.skillbase.member.role.created";
    public static final String MEMBER_ROLE_DELETED = "com.headspin.skillbase.member.role.deleted";
    public static final String MEMBER_ROLE_UPDATED = "com.headspin.skillbase.member.role.updated";
